-- GMG Events MVC database repair and seed
-- Use when admin login succeeds but the dashboard reports a server error.
-- This file creates any missing application tables inside `gmigroup` and restores event seed data.
...
-- Global Marine Group Events MVC - Existing Events Seed for database `gmigroup`
USE gmigroup;
