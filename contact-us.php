        ...
        <div class="container">
            <div class="footer-grid-responsive">
                ...
                <div>
                    ...
                    <ul style="list-style:none;padding:0;margin:0;">
                        <li class="footer-contact-responsive"><i class="fas fa-map-marker-alt"></i>292, R.A. de Mel Mawatha, Colombo 00300, Sri Lanka</li>
                        <li class="footer-contact-responsive"><i class="fas fa-phone"></i>+94 114 614 521</li>
