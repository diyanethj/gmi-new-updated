...
try {
    ...
    error_log('Footer contact load failed on join crew page: ' . $exception->getMessage());
...
<head>
    ...
    <meta name="description" content="Explore current join as crew opportunities at Global Marine Services.">
    <meta name="robots" content="index, follow">
    <meta name="language" content="English">
    <meta name="author" content="Global Marine Group">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Join as Crew - Global Marine Group</title>
    ...
    <section class="careers-section">
        <div class="container">
            ...
            <div class="careers-intro reveal">
                <div class="careers-kicker"><i class="fas fa-compass"></i> Careers at Sea</div>
                <h1>Join Global Marine Services as Crew</h1>
                <p>Explore current seafarer and maritime opportunities through Global Marine Services. Review available crew positions, responsibilities and qualifications, then submit your application directly through the form below.</p>
...
<section class="vacancies-section">
                ...
                <div class="careers-heading vacancy-listing-heading reveal">
                    <h2>Current GMS Vacancies</h2>
                    <p>Explore the active opportunities currently available at Global Marine Services.</p>
                </div>
<?php
                ...
                ?>
                <?php foreach ([['GMS', $gmsVacancies, 'Global Marine Services']] as [$companyCode, $companyVacancies, $companyName]): ?>
                ...
                <?php
                    $pageActiveVacancies = array_values(array_filter(
                        ...
                        static fn(array $vacancy): bool =>
                            strtoupper(trim((string) ($vacancy['company'] ?? ''))) === 'GMS'
                    ));
                ?>
                <section id="application-form" class="application-section reveal">
                    <div class="careers-heading"><h2>Apply for a GMS Vacancy</h2><p>Complete the form and upload your CV. Accepted file types: PDF, DOC, and DOCX, maximum 5 MB.</p></div>
                    ...
                    <?php else: ?>
                    <form method="post" enctype="multipart/form-data" action="<?= e(base_url('vacancies-gms.php')) ?>">
                        <?= csrf_field() ?>
