...
try {
    ...
    error_log('Footer contact load failed on careers page: ' . $exception->getMessage());
    ...
    <section class="careers-section">
        <div class="container">
            ...
            <section class="vacancies-section">
                <div class="careers-heading careers-opportunity-heading reveal">
                    <h2>Career Opportunities</h2>
                    <p>Choose the career path that matches your experience and explore the latest opportunities available across Global Marine Group.</p>
                </div>

                <div class="career-pathways">

                    <!-- JOIN AS EMPLOYEE -->
                    <article class="career-pathway reveal">
                        <div class="career-pathway-image">
                            <img
                                src="images/careers/join-employee.png"
                                alt="Join Global Marine Group as an employee"
                                loading="lazy"
                                decoding="async"
                            >
                        </div>

                        <div class="career-pathway-content">
                            <div class="career-pathway-kicker">Global Marine Group</div>
                            <h2>Vacancies at GMG</h2>
                            <p>
                                Explore shore-based career opportunities across Global Marine Group
                                and build your future with a professional team working across shipping,
                                logistics, marine services and related business sectors.
                            </p>

                            <a class="career-join-btn" href="vacancies-gmg.php">
                                Join Now
                    ...
                    <!-- JOIN AS CREW -->
                    <article class="career-pathway career-pathway-reverse reveal">
                        <div class="career-pathway-image">
                            <img
                                src="images/careers/join-crew.png"
                                alt="Join Global Marine Services as crew"
                                loading="lazy"
                                decoding="async"
                            >
                        </div>
                        ...
                        <div class="career-pathway-content">
                            <div class="career-pathway-kicker">Global Marine Services</div>
                            <h2>Vacancies at GMS</h2>
                            <p>
                                Explore seafarer and maritime career opportunities through Global
                                Marine Services. Join our professional marine network and discover
                                opportunities to grow your career at sea.
                            </p>

                            <a class="career-join-btn" href="vacancies-gms.php">
                                Join Now
                                <i class="fas fa-arrow-right"></i>
                            </a>
                        </div>
