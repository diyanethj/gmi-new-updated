...
try {
    ...
    error_log('Footer contact load failed on events page: ' . $exception->getMessage());
...
<div class="section-eyebrow">News &amp; Events</div>
<h1>Latest Events</h1>
<p>Explore the latest celebrations, partnerships, milestones, CSR initiatives and corporate activities across Global Marine Group.</p>
</div>
<div class="events-grid">
<?php if ($events === []): ?>
    <div class="event-card card-visible" style="grid-column:1/-1;min-height:240px;align-items:center;justify-content:center;text-align:center;padding:35px;">
        <div class="event-content"><h3>No events available</h3><div class="event-excerpt"><p>Published events will appear here.</p></div></div>
    </div>
<?php endif; ?>
<?php foreach ($events as $event): ?>
<div class="event-card">
    <div class="event-image"><img alt="<?= e($event['name']) ?>" decoding="async" loading="lazy" src="<?= e(asset_url($event['main_image'])) ?>"/></div>
    <div class="event-content">
        <h3><a href="<?= e(base_url('event-details.php?slug=' . rawurlencode($event['slug']))) ?>"><?= e($event['name']) ?></a></h3>
        <div class="event-meta"><i class="fas fa-calendar-alt"></i><?= e(format_event_date($event['event_date'])) ?><br/><i class="fas fa-user"></i><a href="https://gmigroup.lk/"><?= e($event['company']) ?></a></div>
        <div class="event-excerpt"><p><?= e(excerpt($event['description'])) ?></p></div>
        <a class="read-more" href="<?= e(base_url('event-details.php?slug=' . rawurlencode($event['slug']))) ?>">read more <i class="fas fa-angle-double-right"></i></a>
    </div>
</div>
<?php endforeach; ?>
</div>
...
<a aria-label="LinkedIn" href="<?= e((string) $footerContact['linkedin_url']) ?>" target="_blank" rel="noopener noreferrer"><i class="fab fa-linkedin-in"></i></a>
<?php endif; ?>
<?php if (!empty($footerContact['facebook_url'])): ?>
<a aria-label="Facebook" href="<?= e((string) $footerContact['facebook_url']) ?>" target="_blank" rel="noopener noreferrer"><i class="fab fa-facebook-f"></i></a>
<?php endif; ?>
<?php if (!empty($footerContact['instagram_url'])): ?>
<a aria-label="Instagram" href="<?= e((string) $footerContact['instagram_url']) ?>" target="_blank" rel="noopener noreferrer"><i class="fab fa-instagram"></i></a>
<?php endif; ?>
<?php if (!empty($footerContact['tiktok_url'])): ?>
<a aria-label="TikTok" href="<?= e((string) $footerContact['tiktok_url']) ?>" target="_blank" rel="noopener noreferrer"><i class="fab fa-tiktok"></i></a>
<?php endif; ?>
<?php if (!empty($footerContact['youtube_url'])): ?>
<a aria-label="YouTube" href="<?= e((string) $footerContact['youtube_url']) ?>" target="_blank" rel="noopener noreferrer"><i class="fab fa-youtube"></i></a>
<?php endif; ?>
</div>
</div>
<div>
...
<i class="fas fa-map-marker-alt"></i><span><?= e((string) ($footerContact['address'] ?? '')) ?></span>
</li>
<li class="footer-contact-responsive">
<i class="fas fa-phone"></i><a href="tel:<?= e((string) $footerPhoneHref) ?>" style="color:inherit;text-decoration:none;"><?= e((string) ($footerContact['phone'] ?? '')) ?></a>
</li>
<li class="footer-contact-responsive">
<i class="fas fa-envelope"></i><a href="mailto:<?= e((string) ($footerContact['email'] ?? '')) ?>" style="color:inherit;text-decoration:none;"><?= e((string) ($footerContact['email'] ?? '')) ?></a>
</li>
<li class="footer-contact-responsive">
<i class="fas fa-clock"></i><span><?= e((string) ($footerContact['office_hours'] ?? '')) ?></span>
</li>
</ul>
</div>
